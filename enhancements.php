...
if (!$isLoggedIn) {//if user not logged in then
    ...
    if ($isManager) {
        echo '<p class="leafbytebuttons"><a href="./manage.php" style="padding:1em 2em; font-size:1.5em; border-radius:50px; display:inline-block; class="CustomLink">Manage</a></p>';
        echo '<p class="leafbytebuttons"><a href="./manage.php" style="padding:1em 2em; font-size:1.5em; border-radius:50px; display:inline-block; class="CustomLink">Manage</a></p>';
    echo '</div>';
    }
}
